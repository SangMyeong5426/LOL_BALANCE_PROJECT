...
#### 왜 상위 10 인가 (2026-08-29)

README 가 「172종을 10종으로 좁힌다」고 적어 두고 **근거를 안 달았다.** 잘라 봤다.
    ...
    패치당 실제 조정 수   중앙값 21 · 범위 11~41
      ...
      상위    정밀도   맞는 수   재현율   헛짚는 수
       ...
       10    34.2%     3.4    15.0%      6.6    ← 지금
       20    28.2%     5.6    23.3%     14.4
       40    24.2%     9.7    39.7%     30.3

**정밀도는 5에서 꼭대기를 찍는다.** 그런데 5로 줄이면 맞는 수가 3.4 에서 2.0 으로
준다 — 정밀도 6%p 를 얻고 실제 후보 40% 를 잃는 거래다. 10 은 기준선의 2.3배이면서
사람이 근거·경고까지 훑을 수 있는 양이라 거기 뒀다. **「제일 확실한 것만」이 필요하면
`--top 5` 가 이미 된다.**

**재현율 15% 는 숨기지 않는다.** 조정될 21종 중 3종만 잡는다. 20 을 뽑아도 23% 라,
순위를 넓혀서 해결되는 문제가 아니다 — 위의 천장이 그대로 나타난 것이다.
