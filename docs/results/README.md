...
표에서 **①′ 너프가 22개 소집단 중 20개에서 양수다.** 「신호는 있는데 표본이
...
##### 개발사는 모집단 넷을 보고 우리는 하나 반을 본다

위 표에서 더 중요한 것은 문턱이 아니라 **모집단이 넷**이라는 점이다.
...
**아카이브에 다른 모집단이 있기는 하다.** 다만 우리 74패치 구간에는 거의 없다.

    emerald_plus     53패치    ← 쓰고 있는 것
    master_plus       5패치    ← Elite
    gold              5패치
    overall           4패치
    platinum_plus     3패치
...
##### 안전장치는 우리 구간에서 한 번도 안 켜진다

「조정 중 절반 넘게 버프면」이 조건인데, 학습 구간에서 최근 3패치 버프 비율은
**중앙값 27.3% · 최대 47.3%** 다. 50% 를 넘은 적이 없다. 2023~2026 패치는
일관되게 너프 편중이라 **개발사 자신의 안전장치가 발동할 자리가 없었다.**
