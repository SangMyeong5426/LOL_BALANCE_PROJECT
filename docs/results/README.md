...
#### 데이터 쪽을 밀어 봤다 — **아홉 갈래 · 93회 측정, 전부 실패** (2026-09-01)
...
**공개된 버프 편중 안전장치는 우리 구간에서 한 번도 안 켜진다.** 「조정 중 절반
넘게 버프면」이 조건인데 학습 구간의 최근 3패치 버프 비율은 **중앙값 27.3% ·
최대 47.3%** 다. 2023~2026 패치는 일관되게 너프 편중이라 발동할 자리가 없었다.
...
**예측 피처로도 대 봤고 안 올랐다** — [데이터 쪽을 밀어 봤다](#데이터-쪽을-밀어-봤다--아홉-갈래--93회-측정-전부-실패-2026-09-01)의
