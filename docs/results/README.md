...
이상인 선수를 단계별 인원에 비례해 뽑아 그 경기를 받았다. 두 패치 모두 u.gg 의
스냅샷 시각 전 경기만 센다.

| 패치 | 직접 집계 | u.gg | 창 |
| --- | ---: | ---: | --- |
| `16_15` | 4,487판 · 선수 804명 (모은 것은 7,468판 · 1,078명) | 334,500판 | 출시 ~ 07-31 14:05Z |
| `16_13` | 4,479판 · 선수 395명 | 2,254,893판 | 출시 ~ 07-06 18:34Z |
...
수집의 다른 한계도 여기 적는다. 한 패치는 **선수 256~509명**에서 왔고(선수당 최대
20판), 그래서 **한 챔피언의 경기가 몇 사람에게 쏠린다** — `16_16` 의 Ornn 은 123판
중 20판이 한 선수다(최대 16%). 구간은 챔피언을 재표본할 뿐 선수를 재표본하지 않는다.
**선수를 군집으로 놓고 다시 재 봤다** — 세진 13종 행의 가를 수 있는 최소 차이가
